...
# Тест 3. Ошбика при вводе в имя пользователя кол-ва символов меньше допустимого
# Параметр fisrtName состоит из 1 символа

def test_create_user_1_letter_in_first_name_get_error_response():
    negative_assert("A")

# Тест 4. Ошбика при вводе в имя пользователя кол-ва символов больше допустимого
...
# Тест 7. Ошбика при вводе в имя пользователя пробелов

def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert("Человек и Ко")

# Тест 8. Ошбика при вводе в имя пользователя спецсимволов

def test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert("№%@")

# Тест 9. Ошбика при вводе в имя пользователя цифр
